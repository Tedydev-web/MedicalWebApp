...
namespace WebAppYte.Controllers
{
    public class BacsiController : Controller
    {
        ...
        {
            var quanTris = db.QuanTris.Include(q => q.Khoa).Where(x => x.VaiTro == 2 || x.VaiTro == 4);
        ...
        public ActionResult Xacnhanlichhen(int? id)
        {
            ...
            ViewBag.TrangThai = new SelectList(db.LichKhams, "TrangThai", "TrangThai", lichKham.TrangThai);
